...
class Ensemble_Params(Params):
    ...
    def parse_args(self, args):
        ...
        self.bindingtrainposfile = target_root + TRAIN_POS_FILENAME
        self.bindingtrainnegfile = target_root + TRAIN_NEG_FILENAME
        ...
        self.modelfile = MODEL_ROOT + self.tf + "/" + self.target_species + "_trained/ensemble_model/" + timestamp + "_run" + str(self.run)
