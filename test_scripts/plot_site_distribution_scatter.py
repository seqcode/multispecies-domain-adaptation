...
big_include = SPECIES + ['multi_model', 'BA_model', 'DA_model', "ensemble_model", "ensemble_model_reg"]
...
def make_preds_and_labels_dfs(avg_preds, labels):
    ...
    for tf in TFS:
        ...
        for train_species in big_include:
            try:
                preds_from_train_species = avg_preds[train_species][tf]
